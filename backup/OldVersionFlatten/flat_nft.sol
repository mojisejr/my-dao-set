...
// File contracts/NFT/Chicken.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.9;


contract ChickenDAO is ERC721, ERC721Enumerable, AccessControl, ERC721Votes {
    ...
    constructor(address _admin, address _treasury, address _dev) ERC721("ChickenDAO", "CIK") EIP712("ChickenDAO", "1") {
    ...
    function mint() public payable {
        ...
        //to dev 50% to dao 50% fair enough ? 
        uint256 half = msg.value / 2;
  
        (bool devSuccess, bytes memory returndata) = dev.call{value: half}("");
        (bool daoSuccess, bytes memory returndata1) = treasury.call{value: half}("");
    ...
    function requestBaseUri(uint256 _tokenId) public {
        ...
        requestCounter += 1;
        emit RequestBaseUri(_tokenId, msg.sender);
    }
